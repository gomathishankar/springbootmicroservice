...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get build Version of the application"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version of the application"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<String> getJavaVersionFallback(Throwable throwable) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body("17");
    }

    @Operation(
            summary = "Get Contact Info",
            description = "Get Contact Information of the application owner"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
